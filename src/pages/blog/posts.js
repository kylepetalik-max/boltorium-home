...
export const POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Garage and shop exist so the loop feels like a rider culture product — tune your fleet, chase missions, climb crew rank — while the market token (Boltz / BTR) launches separately via Jupiter DTF. RTL mainnet stays on boltorium.co — not Jupiter.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'Anti-cheat is qualitative proof we can stand behind today: the gate is live in the demo app. Scaled RTL (via boltorium.co) and Jupiter DTF BTR market rails are planned; fake rider counts are not part of the story.',
    ],
  },
  {
